...
This is the locally adapted snapshot in `Jason-Yao-Builder/Skills/anysearch`, not the current upstream release. Python needs `requests`; the Bash CLI needs `curl` and `jq`. See README.md and NOTICE for installation and provenance.
